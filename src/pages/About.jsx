        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white">
          <div className="max-w-lg px-4">
            <h1 className="text-4xl font-bold leading-tight mb-4">
              Welcome to the Best Car Marketplace
            </h1>
            <p className="text-lg mb-6">
              Find your dream car today with ease. Browse through the best car
              listings, get unbeatable deals, and much more!
            </p>
            <a
              href="#features"
      ...
      <section className="py-16 bg-gray-100" id="mission">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Our mission is to provide a seamless, transparent, and efficient car
            buying experience for all. Whether you're a first-time buyer or an
            experienced car enthusiast, we strive to help you find the perfect
            vehicle at the best price.
          </p>
          <p className="text-lg text-gray-700">
            Join us in revolutionizing the car marketplace with cutting-edge
            technology and a commitment to customer satisfaction.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="flex flex-col items-center justify-center feature-card p-6 bg-gray-50 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
              ...
              <p className="text-gray-600">
                Find the perfect car in minutes with advanced search filters.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center feature-card p-6 bg-gray-50 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
              ...
              <p className="text-gray-600">
                Explore a vast variety of cars from trusted dealers and private
                sellers.
              </p>
            </div>
            <div className="flex flex-col items-center justify-centerfeature-card p-6 bg-gray-50 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
              ...
              <p className="text-gray-600">
                We ensure that every car listed is verified and free from hidden
                issues.
              </p>
            </div>
            <div className="flex flex-col items-center justify-center feature-card p-6 bg-gray-50 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
              ...
              <p className="text-gray-600">
                Join a community of car enthusiasts and buyers who share reviews
                and tips.
              </p>
            </div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg mb-16 max-w-2xl mx-auto">
            Our talented and dedicated team members are the backbone of our
            success.
          </p>
         ...
         {/*    <div className="team-member text-center bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-500 text-sm">
                Spearheading cutting-edge technology and ensuring seamless
                performance.
              </p>
            </div> */}
         ...
         {/*    <div className="team-member text-center bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-500 text-sm">
                Crafting impactful marketing strategies to reach and engage
                audiences.
              </p>
            </div> */}
            {/* Team Member 4 */}
